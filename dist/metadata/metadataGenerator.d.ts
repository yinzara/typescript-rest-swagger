...
export declare class MetadataGenerator {
    ...
    getClassDeclaration(className: string, nodes?: ReadonlyArray<ts.Node>): ts.ClassDeclaration | undefined;
    getInterfaceDeclaration(className: string, nodes?: ReadonlyArray<ts.Node>): ts.InterfaceDeclaration | undefined;
